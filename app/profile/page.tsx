      ...
      <div className="max-w-5xl mx-auto py-8 md:py-10 px-4 sm:px-6">
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-5 md:p-8 mb-4">
          <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-5 md:gap-0">
            <div className="flex flex-col md:flex-row md:items-center md:space-x-5 gap-4 md:gap-0">
              {profile?.avatar_url ? (
                <Image
            ...
            <Link
              href="/profile/edit"
              className="px-4 py-1.5 border border-gray-200 rounded-full text-gray-600 hover:bg-gray-50 text-sm whitespace-nowrap transition-colors"
            >
              プロフィールを編集
            </Link>
          </div>
        ...
        <div className="grid grid-cols-2 gap-3 mb-4">
          <div className="bg-white rounded-xl border border-gray-100 p-4 text-center">
            ...
            <p className="text-xs text-gray-400 mt-1">公開した作品</p>
          </div>
          <div className="bg-white rounded-xl border border-gray-100 p-4 text-center">
            <p className="text-2xl font-bold text-red-400">
              {projects.reduce((sum, p) => sum + (p.likes_count || 0), 0)}
            </p>
            <p className="text-xs text-gray-400 mt-1">もらったいいね</p>
          </div>
        </div>
        ...
        <div>
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 sm:gap-0 mb-5">
            ...
            <Link
              href="/projects/new"
              className="px-4 py-1.5 bg-emerald-500 text-white rounded-full hover:bg-emerald-600 text-sm whitespace-nowrap text-center transition-colors"
            >
              新しく公開する
            </Link>
          </div>
